...
import { modalVariants, backdropVariants } from '../../motion/motionTokens';
            ...
            <div className="lg:col-span-5 space-y-4 bg-[#F7F9FC] p-5 rounded-2xl border border-[#E5E7EB] shadow-2xs">
              ...
              <div className="flex items-center justify-between pt-2 border-t border-[#E5E7EB]">
                ...
                >
                  <motion.span
                    layout
                    className={`pointer-events-none inline-block h-4 w-4 rounded-full bg-white shadow-2xs ${
            ...
            <div className="lg:col-span-7 flex flex-col">
              {error && (
                <motion.div
                  ...
                  className="p-4 rounded-xl bg-[#FFF1F2] border border-[#FECDD3] text-[#9F1239] text-xs flex items-center gap-2 mb-4 shadow-2xs"
                >
              ...
              {result && (
                <motion.div
                  ...
                  className="space-y-4"
                >
                  {/* Top Metrics Cards with Count-Up Animations */}
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    <div className="p-3.5 rounded-xl bg-[#F7F9FC] border border-[#E5E7EB] shadow-2xs">
                      ...
                      <div className="text-lg font-black text-[#059669] font-sans mt-0.5">
                        <AnimatedNumber value={result.simulated_recovery_rate * 100} decimals={1} suffix="%" />
                      </div>
                    ...
                    <div className="p-3.5 rounded-xl bg-[#F7F9FC] border border-[#E5E7EB] shadow-2xs">
                      ...
                      <div className="text-lg font-black text-[#7C3AED] font-sans mt-0.5">
                        +<AnimatedNumber value={result.recovery_uplift_pp} decimals={2} suffix=" pp" />
                      </div>
                    ...
                    <div className="p-3.5 rounded-xl bg-[#F7F9FC] border border-[#E5E7EB] shadow-2xs">
                      ...
                      <div className="text-lg font-black text-[#3B5BDB] font-sans mt-0.5">
                        <AnimatedNumber
                          value={Math.round(result.recovered_revenue_inr)}
                          prefix="₹"
