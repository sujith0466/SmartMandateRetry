    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          animate="animate"
          exit="exit"
          className="bg-white border border-[#E5E7EB] rounded-2xl w-full max-w-2xl shadow-fintech-modal overflow-hidden"
        >
          {/* Header */}
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            {error && (
              <motion.div
                ...
                className="p-3.5 rounded-xl bg-[#FFF1F2] border border-[#FECDD3] text-[#9F1239] text-xs flex items-center gap-2 shadow-2xs"
              >
            ...
            {diffs.length > 0 && (
              <motion.div
                ...
                className="p-3.5 bg-[#FFFBEB] rounded-xl border border-[#FDE68A] space-y-1.5 shadow-2xs"
              >
