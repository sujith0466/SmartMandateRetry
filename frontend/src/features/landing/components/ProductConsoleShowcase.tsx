...
export const ProductConsoleShowcase: React.FC = () => {
  ...
  return (
    <section className="py-24 bg-white border-b border-[#E5E7EB] relative">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 space-y-16">
        {/* Header */}
        <div className="text-center max-w-3xl mx-auto space-y-3">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#EEF2FF] border border-[#C7D2FE] text-xs font-bold text-[#3B5BDB]">
            ...
            return (
              <button
                ...
                className={`flex-1 min-w-[170px] flex items-center justify-center gap-2 py-3 px-3 rounded-xl text-xs font-bold transition-all ${
                  isSelected
                    ? 'bg-white text-[#3B5BDB] shadow-sm border border-[#C7D2FE]'
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="lg:col-span-7 bg-white rounded-2xl p-6 border border-[#E5E7EB] shadow-md space-y-4">
              ...
              <div className="p-4 rounded-xl bg-[#F7F9FC] border border-[#E5E7EB] space-y-3 text-xs">
