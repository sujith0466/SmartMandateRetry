...
export const ArchitectureSection: React.FC = () => {
  ...
  return (
    <section id="architecture" className="py-24 bg-[#F7F9FC] relative">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <motion.div
            ...
            className="p-6 rounded-3xl bg-white border border-[#E5E7EB] space-y-4 shadow-sm flex flex-col justify-between"
          >
            <div className="space-y-3">
              <div className="p-3 rounded-2xl bg-[#F5F3FF] border border-[#DDD6FE] text-[#7C3AED] w-fit shadow-2xs">
                <Cpu className="w-6 h-6" />
              </div>
              <h3 className="text-base font-bold text-[#111827]">1. Probabilistic AI Decision Engine</h3>
              ...
              <div className="space-y-2 pt-2 border-t border-[#E5E7EB] text-xs">
                <div className="flex items-center gap-2 text-[#475569]">
                  ...
                  <span>Gemini 2.0 Flash + Resilient OpenRouter Failover</span>
                </div>
                <div className="flex items-center gap-2 text-[#475569]">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#7C3AED]" />
