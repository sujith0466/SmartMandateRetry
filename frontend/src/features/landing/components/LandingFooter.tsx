...
export const LandingFooter: React.FC = () => {
  return (
    <footer className="bg-white border-t border-[#E5E7EB] py-14 text-[#64748B] text-xs">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 space-y-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-2.5">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="hover:text-[#3B5BDB] transition-colors">
                  Recovery Dashboard
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-2.5">
            ...
            <div className="space-y-2">
              ...
              <div className="text-[11px] text-[#64748B]">
                Integration: Razorpay Mandates Webhook Engine
              </div>
              <div className="text-[11px] text-[#64748B]">
        ...
        {/* Bottom copyright */}
        <div className="pt-8 border-t border-[#E5E7EB] flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px]">
