...
export const FinancialImpactSection: React.FC = () => {
  const reducedMotion = useReducedMotion();

  return (
    <section id="financials" className="py-24 bg-[#F7F9FC] relative">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 space-y-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          <motion.div
            ...
            className="p-6 rounded-3xl bg-white border border-[#A7F3D0] ring-2 ring-[#ECFDF5] shadow-sm space-y-2"
          >
          ...
          <motion.div
            ...
            className="p-6 rounded-3xl bg-white border border-[#E5E7EB] shadow-sm space-y-2"
          >
            <div className="flex justify-between items-center">
            ...
            <div className="text-3xl font-black text-[#111827] font-sans">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="p-6 rounded-3xl bg-white border border-[#E5E7EB] shadow-sm space-y-4">
            <div className="flex items-center gap-3 border-b border-[#E5E7EB] pb-3">
              <div className="p-2 rounded-xl bg-[#ECFEFF] text-[#0891B2] border border-[#A5F3FC]">
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-xs font-bold">
                ...
                <span className="text-[#059669] font-mono font-black">66.7% (4 of 6 Settled)</span>
              </div>
          ...
          <div className="p-6 rounded-3xl bg-white border border-[#E5E7EB] shadow-sm space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-xs font-bold">
                <span className="text-[#475569]">Conversion Yield:</span>
                <span className="text-[#3B5BDB] font-mono font-black">25.0% (1 of 4 Settled)</span>
              </div>
              <div className="w-full bg-[#F1F5F9] rounded-full h-2 overflow-hidden border border-[#E5E7EB]">
